              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="phone_number" name="phone_number" placeholder="Contact Phone Number +380XXXXXXX" value="@{{phone_number}}" ng-model="contact.phone_number" mask="+999999999999"  ng-required="true">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="birth_day" name="birth_day"  placeholder="Contact Birth Day: XXXX-XX-XX" value="@{{birth_day}}" ng-model="contact.birth_day"  mask="2999-19-39" ng-required="true">
